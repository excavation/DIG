...
#if defined(NDEBUG)
# error "Excavate cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Excavate Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nHeight, int64_t nFees)
{
    ...
    // Reserved for Swap from Initial Excavate Chain Launch
    else if(nHeight > nReservePhaseStart) {
