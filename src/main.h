...
static const int64_t MAX_SINGLE_TX = 10000000000 * COIN; // 10 Billion (Same As Cap)
/** PoS Subsidy */
static const int64_t COIN_YEAR_REWARD = 250 * CENT; // Miscalculated (2 day hinderance, no major issues)
/** PoS Subsidy 2 */
static const int64_t COIN_YEAR_REWARD2 = 19 * CENT; // ~25% annually
/** PoS Subsidy 3 */
static const int64_t COIN_YEAR_REWARD3 = 4 * CENT; // ~5% annually
/** PoS Subsidy 4 */
static const int64_t COIN_YEAR_REWARD4 = 0.8 * CENT; // ~1% Correct numbers
/** Genesis block subsidy */
static const int64_t nGenesisBlockReward = 1 * COIN;
/** Reserve block subsidy */
static const int64_t nBlockRewardReserve = 10000000 * COIN; // 7.5B 
...
static const int64_t nReservePhaseEnd = 356; 
/** PoS25 Phase start block */
static const int64_t nPoS25PhaseStart = 20000; // 
/** PoS5 Phase start block */
static const int64_t nPoS5PhaseStart = 2000800; 
/** PoS1 Phase start block */
static const int64_t nPoS1PhaseStart = 3000300; // 
...
static const int nCoinbaseMaturity = 30;
/** Money Range Params */
