// Copyright (c) 2016 The CryptoCoderz Team / Excavate
    ...
    model(0)
{
    ...
    else if(check_standalone.exists())
    {
        ...
        //open a file
        QFile iniFILE(QDir::currentPath() + "/DIG.cfg");
...
void ClientControlPage::on_chck4_upd8_clicked()
{
    ...
    QString fileX = QDir::currentPath() + "/Excavate_Launcher.exe";
    process->start(fileX);
}
...
void ClientControlPage::on_dwngrd_opt_clicked()
{
    QMessageBox::information(this, "No Available Versions",
                       "v0.0.0.1 cannot be downgraded, only later versions can.",
                       QMessageBox::Ok );
}
...
{
    QMessageBox::information(this, "Coming in v0.0.0.1",
                       "Please email your issues to bitc0der2245@gmail.com",
                       QMessageBox::Ok );
}
