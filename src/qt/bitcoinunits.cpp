...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("Excavate");
    case mBTC: return QString("Milli-Excavate (1 / 1,000)");
    case uBTC: return QString("Micro-Excavate (1 / 1,000,000)");
    default: return QString("???");
    }
}
