// Copyright (c) 2016 The Excavate developers
...
void BlockBrowser::updateExplorer(bool block)
{
    ...
    if(block == false) {
        ...
        ui->valueBox->setText(QValue + " DIG");
        ui->txID->setText(QID);
        ui->outputBox->setText(QOutputs);
        ui->inputBox->setText(QInputs);
        ui->feesBox->setText(QFees + " DIG");
    }
}
...
void BlockBrowser::updateStatistics()
{
    ...
    {
        ui->volumeBox_2->setText("<b><font color=\"green\">" + qVolume + " DIG" + "</font></b>");
    } else if(volume < volumePrevious) {
        ui->volumeBox_2->setText("<b><font color=\"red\">" + qVolume + " DIG" + "</font></b>");
    } else {
        ui->volumeBox_2->setText(qVolume + " DIG");
    }
