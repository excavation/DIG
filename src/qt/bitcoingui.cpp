...
{
    resize(900+95, 350);
    setWindowTitle(tr("Excavate") + " - " + tr("Client"));
#ifndef Q_OS_MAC
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a Excavate address"));
    ...
    generateAction = new QAction(QIcon(":/icons/generate"), tr("&Generate DIG"), this);
    generateAction->setToolTip(tr("Excavate mining and generation management"));
    ...
    messageAction->setToolTip(tr("Excavate secure messaging page"));
    ...
    blockbrowserAction->setToolTip(tr("Browse and access block details of the Excavate chain"));
    ...
    siteonChainAction->setToolTip(tr("Excavate Site on Blockchain (Websites on the Chain)"));
    ...
    aboutAction = new QAction(tr("&About Excavate"), this);
    aboutAction->setToolTip(tr("Show information about Excavate"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for Excavate"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("Excavate client") + QString(" ") + tr("[testnet]"));
...
//        clientcontrolPage->setModel(clientModel);
    }
}
...
void BitcoinGUI::setWalletModel(WalletModel *walletModel)
{
    ...
    //    clientcontrolPage->setModel(walletModel);
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("Excavate client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Excavate network", "", count));
}
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid Excavate address or malformed URI parameters."));
    }
